---
title: "Lab-12 Replication File"
output: html_notebook
---

## Introduction
This is the replication file for lab-12.

## Dependencies
This replication file requires data from `testDriver` as well as `ggplot2`:
...
## Load Data
We will use the `auto17` data from the `testDriveR` package:
